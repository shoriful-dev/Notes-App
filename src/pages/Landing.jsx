        ...
        <div className="min-h-screen bg-white font-inter text-slate-900 overflow-x-hidden">
            ...
            <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-xl border-b border-slate-100">
                <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
                    <div className="flex items-center gap-2.5">
                        ...
                        <span className="font-bold text-lg">Notes<span className="text-blue-600">App</span></span>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                        {!user ? (
                            <>
                                <Link to="/login" className="text-sm font-semibold text-slate-600 hover:text-blue-600 transition-colors px-3 hidden sm:block">Log in</Link>
                                <button
                                    onClick={() => navigate('/signup')}
                                    className="bg-blue-600 hover:bg-blue-700 text-white text-sm font-bold px-5 py-2.5 rounded-xl shadow-md shadow-blue-200 transition-all active:scale-95"
                                >
                                    Get Started Free
                                </button>
                            </>
                            ...
                            <button
                                ...
                                className="bg-blue-600 hover:bg-blue-700 text-white text-sm font-bold px-5 py-2.5 rounded-xl shadow-md shadow-blue-200 transition-all active:scale-95 flex items-center gap-2"
                            >
            ...
            <main>
                ...
                <section className="pt-36 pb-28 px-6 relative overflow-hidden">
                    {/* Background blobs */}
                    <div className="absolute top-20 left-1/2 -translate-x-1/2 w-[900px] h-[500px] bg-blue-50 rounded-full blur-3xl -z-10 opacity-70"></div>
                    <div className="absolute top-40 right-10 w-72 h-72 bg-violet-100/60 rounded-full blur-3xl -z-10"></div>
                    ...
                    <div className="max-w-5xl mx-auto text-center">
                        ...
                        <h1 className="text-5xl sm:text-6xl md:text-[5.5rem] font-extrabold text-slate-900 tracking-tight leading-[1.05] mb-6">
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
                            {!user ? (
                                <>
                                    <button
                                        onClick={() => navigate('/signup')}
                                        className="group h-14 px-8 bg-blue-600 hover:bg-blue-700 text-white font-bold text-lg rounded-2xl shadow-xl shadow-blue-200 transition-all active:scale-95 flex items-center gap-2"
                                    >
                                        Start for Free
                                    ...
                                    <Link
                                        to="/login"
                                        className="h-14 px-8 font-bold text-lg text-slate-600 hover:text-blue-600 transition-colors flex items-center gap-2 border border-slate-200 rounded-2xl hover:border-blue-200 bg-white"
                                    >
                                ...
                                <button
                                    onClick={() => navigate('/dashboard')}
                                    className="group h-14 px-10 bg-blue-600 hover:bg-blue-700 text-white font-bold text-lg rounded-2xl shadow-xl shadow-blue-200 transition-all active:scale-95 flex items-center gap-2"
                                >
                                    Go to Dashboard
                            ...
                            <div className="flex items-center gap-2">
                                <div className="flex -space-x-2">
                                    {['bg-blue-500','bg-violet-500','bg-emerald-500','bg-amber-500'].map((c,i) => (
                                        <div key={i} className={`w-7 h-7 rounded-full ${c} ring-2 ring-white`}></div>
                                    ))}
                                </div>
                                <span className="font-semibold text-slate-700">10,000+</span> happy writers
                            </div>
                ...
                <section className="px-6 py-4 pb-28">
                    <div className="max-w-6xl mx-auto">
                        <div className="relative group">
                            ...
                            <div className="relative bg-slate-50 border border-slate-200 rounded-[2rem] shadow-2xl overflow-hidden">
                                {/* mock browser bar */}
                                <div className="bg-white border-b border-slate-100 px-5 py-3.5 flex items-center gap-3">
                                    ...
                                    <div className="flex-1 max-w-sm mx-auto bg-slate-100 rounded-lg px-3 py-1 text-xs text-slate-400 font-mono text-center">
                                        notesapp.io/dashboard
                                    </div>
                                </div>

                                {/* mock app content */}
                                <div className="p-6 md:p-8 bg-[#f8fafc] min-h-[380px]">
                                    {/* mock navbar */}
                                    <div className="bg-white rounded-xl border border-slate-100 p-3 flex items-center justify-between mb-6 shadow-sm">
                                        <div className="flex items-center gap-2">
                                            <div className="w-7 h-7 bg-blue-600 rounded-lg flex items-center justify-center">
                                                <BookOpen className="w-4 h-4 text-white" />
                                            </div>
                                            <span className="font-bold text-sm">Notes<span className="text-blue-600">App</span></span>
                                        </div>
                                        <div className="hidden sm:flex bg-slate-100 rounded-lg px-3 py-1.5 text-xs text-slate-400 items-center gap-2 w-48">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                        {[
                                            ...
                                            <div key={i} className="bg-white border border-slate-100 rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow group/card">
                                                <div className="flex items-start justify-between mb-2">
                                                    <h4 className="text-sm font-semibold text-slate-900 leading-tight">{note.title}</h4>
                                                    {note.pinned && <div className="text-blue-600 text-xs font-bold shrink-0 ml-2">📌</div>}
                                                </div>
                                                <p className="text-xs text-slate-500 leading-relaxed line-clamp-2 mb-3">{note.content}</p>
                                                <div className="flex gap-1.5 flex-wrap">
                                                    {note.tags.map(tag => (
                                                        <span key={tag} className="text-[10px] font-semibold text-blue-600 bg-blue-50 px-2 py-0.5 rounded uppercase">{tag}</span>
                                                    ))}
                                                </div>
                                            </div>
                                        ))}
                ...
                <section id="features" className="py-28 px-6 bg-white">
                    <div className="max-w-7xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {features.map((f, i) => (
                                <div key={i} className="group p-8 rounded-2xl border border-slate-100 hover:border-blue-100 hover:shadow-xl hover:shadow-blue-50 transition-all duration-300 bg-white">
                        ...
                        <div className="grid lg:grid-cols-2 gap-16 items-center">
                            <div>
                                ...
                                <div className="space-y-6">
                                    {steps.map((step, i) => (
                                        <div key={i} className="flex gap-5 group">
                                            <div className="shrink-0 w-12 h-12 bg-white rounded-2xl border border-slate-200 flex items-center justify-center shadow-sm group-hover:border-blue-200 group-hover:shadow-blue-100 transition-all">
                                                {step.icon}
                                            </div>
                                            <div>
                                ...
                                <button
                                    ...
                                    className="mt-10 group h-12 px-8 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl transition-all active:scale-95 flex items-center gap-2 shadow-lg shadow-blue-200"
                                >
                            ...
                            <div className="relative hidden lg:block">
                                ...
                                <div className="relative bg-white border border-slate-200 rounded-[2rem] p-8 shadow-2xl space-y-4">
                                    ...
                                    {[
                                        ...
                                        <div key={i} className="bg-slate-50 hover:bg-blue-50/50 cursor-pointer rounded-xl p-4 border border-slate-100 hover:border-blue-100 transition-all group/note">
                                            <div className="flex items-center justify-between">
                                                <span className="text-sm font-semibold text-slate-900 group-hover/note:text-blue-700 transition-colors">{n.title}</span>
                                                {n.pinned && <span className="text-blue-500 text-xs font-bold">📌</span>}
                                            </div>
                                            <div className="flex items-center justify-between mt-2">
                                                <div className="flex gap-1">
                                                    {n.tags.map(t => <span key={t} className="text-[10px] font-semibold text-blue-600 bg-blue-50 px-2 py-0.5 rounded">{t}</span>)}
                                                </div>
                ...
                <section id="testimonials" className="py-28 px-6 bg-white">
                    <div className="max-w-7xl mx-auto">
                        <div className="text-center mb-16">
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-50 border border-amber-100 text-amber-600 text-xs font-bold uppercase tracking-widest mb-4">
                        ...
                        <div className="grid md:grid-cols-3 gap-6">
                            {testimonials.map((t, i) => (
                                <div key={i} className="bg-slate-50 border border-slate-100 rounded-2xl p-8 flex flex-col gap-6">
                                    <div className="flex items-center gap-1">
                                        {[1,2,3,4,5].map(s => <Star key={s} className="w-4 h-4 fill-amber-400 text-amber-400" />)}
                                    </div>
                                    <p className="text-slate-700 leading-relaxed text-[15px] flex-1">"{t.quote}"</p>
                                    <div className="flex items-center gap-3">
                                        <div className={`w-10 h-10 rounded-full ${t.color} text-white flex items-center justify-center font-bold text-sm`}>{t.avatar}</div>
                                        <div>
                ...
                <section className="py-28 px-6 bg-white">
                    <div className="max-w-4xl mx-auto">
                        <div className="relative bg-gradient-to-br from-blue-600 to-blue-700 rounded-[2.5rem] p-12 md:p-20 text-center overflow-hidden shadow-2xl shadow-blue-200">
                            ...
                            <div className="relative z-10">
                                ...
                                <button
                                    onClick={() => navigate(user ? '/dashboard' : '/signup')}
                                    className="group h-14 px-10 bg-white text-blue-600 font-bold text-lg rounded-2xl shadow-xl transition-all active:scale-95 hover:bg-blue-50 flex items-center gap-2 mx-auto"
                                >
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col md:flex-row items-start justify-between gap-10 mb-12">
                        ...
                        <div className="flex items-center gap-4">
                            <a href="#" className="w-9 h-9 bg-slate-800 hover:bg-slate-700 rounded-lg flex items-center justify-center text-slate-400 hover:text-white transition-all">
