        ...
        <div className="flex items-center justify-center min-h-screen bg-[#f8fafc] p-4">
            <div className="max-w-md w-full">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-slate-500 mt-2 font-medium">To keep connected with us please login</p>
                </div>
                ...
                <div className="bg-white rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden">
                    <div className="p-8">
                        ...
                        <button 
                            ...
                            className="w-full bg-white hover:bg-slate-50 border border-slate-200 text-slate-700 rounded-2xl py-4 font-bold transition-all flex items-center justify-center gap-3 active:scale-[0.98]"
                        >
